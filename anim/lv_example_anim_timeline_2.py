...
def event_handler(e):
    ...
    if obj == btn :
        ...
        lv.anim_timeline_t.set_reverse(reverse)
        lv.anim_timeline_start(anim_timeline)
    elif obj == slider:
        progress = slider.get_value(slider)
...
a1.set_custom_exec_cb(set_width)
...
a2.set_custom_exec_cb(set_height)
...
a3.set_custom_exec_cb(set_width)
...
a4.set_custom_exec_cb(set_height)
...
a5.set_custom_exec_cb(set_width)
...
a6.set_custom_exec_cb(set_height)
